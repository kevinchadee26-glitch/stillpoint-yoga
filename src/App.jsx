...
function SettingsScreen({profile,updateLevel,updateName,sound,setSound,onSignOut}){
  ...
  return (
    <div style={{padding:"8px 18px 20px"}}>
      ...
      <p style={{marginTop:22,fontSize:11.5,lineHeight:1.6,color:"var(--muted)",textAlign:"center"}}>Pose illustrations from the Yoga API. Some icons by monkik and dDara via Flaticon. Newer poses show a placeholder until a photo is added.</p>
    </div>
  );
}
